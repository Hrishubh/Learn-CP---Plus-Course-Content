...
public class L2_Rabin_Karp {
	...
	private static void search(String pat, String text, int q) {
		...
		int d = 256; // No of chars in input alphabet
		...
		for (i = 0; i <= N - M; i++) {
			...
			// check the hash value of the current window of text
			// and pattern
			...
			// remove the first digit and add the last one in the end.
